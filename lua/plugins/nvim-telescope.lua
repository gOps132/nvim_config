...
return {
  ...
  config = function()
    ...
    -- Function to copy and rename a selected template with custom destination
    ...
    -- Telescope setup with custom mappings for template creation
    require("telescope").setup({
      defaults = {
        mappings = {
          i = {
            ["<CR>"] = create_project_from_template, -- Enter to select and create
          },
          n = {
            ["<CR>"] = create_project_from_template,
          },
        },
      },
      pickers = {
        find_files = {
          -- For <C-p>, keep default behavior
        },
      },
    })
  end,
